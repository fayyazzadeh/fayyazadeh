const experiences = [
  ["کارشناس IT", "فرودگاه بین المللی مهرآباد", "۰۷/۱۳۹۵ – اکنون", "پشتیبانی سیستم‌های رایانه‌ای، نصب و راه‌اندازی سیستم، انجام امورات پسیو شبکه، آرایش رک، تعمیر و عیب‌یابی و ارتقاء سیستم‌ها، انجام امورات تحت شبکه.", true],
  ["کارشناس IT", "کیان بتون پارسه", "۰۱/۱۴۰۴ – اکنون", "کارشناس فنی و پشتیبانی مجموعه؛ تعمیر و نگهداری سیستم‌های شرکت و کارگاه‌های مستقر در سطح شهر، مدیریت و نگهداری سایت شرکت و مشاوره در زمینه توسعه شبکه.", true],
  ["کارشناس IT", "تعاونی تولیدی توزیعی مجموعه میلاد پرنیا ایرانیان", "۱۰/۱۴۰۳ – اکنون", "کارشناس IT و پشتیبانی دفتر مرکزی و کارخانه؛ مدیریت و پشتیبانی سایت مجموعه؛ مدیریت سرور و دوربین‌های شرکت؛ VMware، ESXi، MikroTik، GRE و VOIP.", true],
  ...
  ["کارشناس IT", "شرکت تعاونی میراث فرهنگی، گردشگری و صنایع دستی ایرانیان", "۰۴/۱۴۰۲ – ۱۲/۱۴۰۲", "مدیر فناوری اطلاعات و ارتباطات، شبکه و سیستم‌های اداری؛ پشتیبانی شبکه و سیستم‌های اداری؛ مسئول وب‌سایت hamiyanco.com؛ مسئول سرویس‌های اجرایی در مجموعه؛ Virtualization، MTCNA، MCSE."],
