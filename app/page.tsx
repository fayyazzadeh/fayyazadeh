const experiences = [
  ...
  ["IT کارشناس", "تعاونی تولیدی توزیعی مجموعه میلاد پرنیا ایرانیان", "۱۰/۱۴۰۳ – اکنون", "IT کارشناس و پشتیبانی دفتر مرکزی و کارخانه؛ مدیریت و پشتیبانی سایت مجموعه؛ مدیریت سرور و دوربین‌های شرکت؛ VMware، ESXi، MikroTik، GRE و VOIP.", true],
